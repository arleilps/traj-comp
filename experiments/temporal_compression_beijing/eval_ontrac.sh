...
results_file_name='ontrac_error.dat'
...
do
	...
	do
		comp_ratio_train_test=$(extract "ONTRAC/train_test_${f}_${d}" "compression_ratio")
		avg_comp_ratio_train_test=`echo "scale=10; $avg_comp_ratio_train_test+$comp_ratio_train_test" | bc`
		
		comp_time_train_test=$(extract "ONTRAC/train_test_${f}_${d}" "compression_time")
		avg_comp_time_train_test=`echo "scale=10; $avg_comp_time_train_test+$comp_time_train_test" | bc`

		train_time_train_test=$(extract "ONTRAC/train_test_${f}_${d}" "training_time")
