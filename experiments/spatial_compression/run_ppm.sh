...
do
	...
	do
#		echo "$traj_comp -c PPM -g $road_net -t $map_matched_traj\_train_$f -e $map_matched_traj\_train_$f -r $d -f $conf_file > PPM/train_train_$f\_$d"
#		$traj_comp -c PPM -g $road_net -t $map_matched_traj\_train_$f -e $map_matched_traj\_train_$f -r $d -f $conf_file > PPM/train_train_$f\_$d
